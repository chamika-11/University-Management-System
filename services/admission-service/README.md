...
## Overview
Handles applicant processing from registration, document submission, entrance exam results, merit lists, offer letters, to fee correlation.
...
- **MeritListGenerationService**
- **OfferLetterService**
- **ApplicationFeeCoordinatorService**
...
- `PaymentCompleted (application fee)`
- `DocumentVerified`
